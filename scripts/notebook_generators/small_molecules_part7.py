"""Part 7 of docs/notebooks/small_molecules.ipynb -- downstream, molecule-only, close."""
...
Path(sys.argv[1] if len(sys.argv) > 1 else "cells_part7.json").write_text(json.dumps(CELLS))
print(f"part 7: {len(CELLS)} cells")
