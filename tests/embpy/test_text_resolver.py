"""Tests for embpy.resources.text.resolver.TextResolver."""
...
class TestMyGeneSource:
    @patch("embpy.resources.text.resolver._get_json", return_value=MYGENE_HIT)
    ...
    @patch("embpy.resources.text.resolver._get_json", return_value={"hits": []})
...
class TestNCBISource:
    @patch("embpy.resources.text.resolver._get_json")
    ...
    @patch("embpy.resources.text.resolver._get_json", return_value=None)
    def test_ncbi_no_results(self, mock_get, resolver):
        assert resolver._fetch_ncbi("FAKEGENE") == ""


class TestEnsemblSource:
    @patch("embpy.resources.text.resolver._get_json", return_value=ENSEMBL_LOOKUP)
...
class TestUniProtSource:
    @patch("embpy.resources.text.resolver._get_json", return_value=UNIPROT_ENTRY)
...
class TestWikipediaSource:
    @patch("embpy.resources.text.resolver._get_json", return_value=WIKIPEDIA_RESPONSE)
...
class TestPubChemSource:
    @patch("embpy.resources.text.resolver._get_json", return_value=PUBCHEM_RESPONSE)
