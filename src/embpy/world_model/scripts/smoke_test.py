...
Usage:
    ...
    python -m embpy.world_model.scripts.smoke_test
"""
...
from embpy.world_model.scripts.train import main as train_main
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="src/embpy/world_model/configs/experiments/smoke.yaml",
    )
