...
CPU_EVAL_TIME="${CPU_EVAL_TIME:-24:00:00}"
CPU_EVAL_MEM="${CPU_EVAL_MEM:-160G}"
CPU_EVAL_CPUS="${CPU_EVAL_CPUS:-4}"

SUPPORT_SIZE="${SUPPORT_SIZE:-16}"
DYNAMICS_KIND="${DYNAMICS_KIND:-incontext_tokens}"
...
echo "  train gpu:    gres=${TRAIN_GRES} constraint=${TRAIN_GPU_CONSTRAINT:-<none>}"
