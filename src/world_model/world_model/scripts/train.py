...
def _build_model(
    ...
    *,
    ...
    return build_world_model(
        ...
        incontext_latent_normalization=getattr(cfg.dynamics, "latent_normalization", "none"),
        incontext_prediction_mode=getattr(cfg.dynamics, "prediction_mode", "absolute"),
        incontext_residual_output_init_scale=getattr(cfg.dynamics, "residual_output_init_scale", 0.01),
...
def _key_hyperparams(cfg: WorldModelConfig) -> dict[str, Any]:
    ...
    return {
        ...
        "dynamics.latent_normalization": cfg.dynamics.latent_normalization,
        "dynamics.prediction_mode": cfg.dynamics.prediction_mode,
        "data.incontext_support_strategy": cfg.data.incontext_support_strategy,
