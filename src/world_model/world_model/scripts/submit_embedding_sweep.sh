...
#
# Per embedding it just calls submit_gene_embeddings.sh (so the prewarm ->
...
#
# Usage:
#   bash src/world_model/world_model/scripts/submit_embedding_sweep.sh
#   DATASET=both bash .../submit_embedding_sweep.sh
...
DRIVER="src/world_model/world_model/scripts/submit_gene_embeddings.sh"
